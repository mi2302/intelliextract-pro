    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button onClick={addEntity} className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-600 rounded-xl text-sm font-bold border border-slate-200 hover:bg-slate-200 transition-all">
        ...
        <div className="pt-10 border-t border-slate-100">
          <div className="flex items-center justify-between mb-8">
            ...
            <button onClick={() => setIsAddingRel(true)} className="text-xs font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-xl border border-blue-200">
            ...
            <div className="mb-8 p-6 bg-blue-50 rounded-2xl border border-blue-200 animate-in slide-in-from-top-4">
              ...
              <div className="flex justify-between items-center bg-white/50 p-4 rounded-xl border border-blue-100">
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={handleSaveRel} disabled={!sourceField || !targetField} className="px-6 py-2 bg-blue-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-blue-500/20 disabled:opacity-50">Save Join</button>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="flex gap-3">
              <div className="relative">
                <button
                  ...
                  className="px-5 py-2.5 bg-green-600 text-white rounded-xl text-xs font-bold hover:bg-green-500 transition-all flex items-center gap-2 shadow-lg shadow-green-600/20"
                >
              ...
              <button
                ...
                className="px-5 py-2.5 bg-blue-600 text-white rounded-xl text-xs font-bold hover:bg-blue-500 transition-all flex items-center gap-2 shadow-lg shadow-blue-600/20"
              >
